                ...
                <form action="#" method="POST">
                    <div class="msg">
                        <div class="alert alert-success">
                            <strong>BERHASIL !</strong> Silahkan Klik <b>LOGIN</b> untuk Masuk Kedalam Aplikasi Pendaftaran.
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12" align="center">
                            <a href="<?= base_url('login') ?>" class="btn bg-blue btn-lg btn-block">LOGIN</button></a>
                        </div>
                    </div>
                </form>
            </div>
