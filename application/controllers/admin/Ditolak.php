...
class Ditolak extends Admin_Controller {
    ...
    public function __construct() {
        ...
        $this->halaman = 'ditolak';
    }

    public function index() {
        $data = [
            'halaman'    => $this->halaman,
            'main'       => 'admin/registrasi/list_tolak',
            'registrasi' => $this->db->where('status', 3)->get('registrasi')->result()
        ];
    ...
    public function detail($id_registrasi) {
        $data = [
            'halaman'    => $this->halaman,
            'main'       => 'admin/registrasi/detail_tolak',
