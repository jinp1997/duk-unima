                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">                                            
                                            <img width="25%" src="<?= base_url('assets/img/logo.png'); ?>" alt="Logo">
                                            <h1 class="h4 text-gray-900 mb-4" style="margin-top: 10px">
                                                <b>ADMINISTRATOR<br><span style="font-size: 16pt;">SISTEM INFORMASI DUK</span></b><br>
                                                <div style="font-size: 14pt">UNIVERSITAS NEGERI MANADO</div>
                                            </h1>
                                        </div>
                                        <form action="<?= site_url('admin/login') ?>" method="POST" class="user" style="margin-bottom: 20px">
        ...
        <footer>
            <div class="container my-auto">
                <div class="copyright text-center my-auto" style="color: #fff; font-size: 8pt">
                    <span>Copyright &copy; UNIVERSITAS NEGERI MANADO | Design By : <b> J-1997</b></span>
                </div>
            </div>
        </footer>
