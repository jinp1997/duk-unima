...
class Diterima extends Admin_Controller {
    ...
    public function __construct() {
        ...
        $this->halaman = 'diterima';
    }

    public function index() {
        $data = [
            'halaman'    => $this->halaman,
            'main'       => 'admin/registrasi/list_terima',
            'registrasi' => $this->db->where('status', 2)->get('registrasi')->result()
        ];
    ...
    public function detail($id_registrasi) {
        $data = [
            'halaman'    => $this->halaman,
            'main'       => 'admin/registrasi/detail_terima',
